    ...
    <h2>you are here</h2>
        <%
            try{
                ...
                //String CreateFeeReceipt = "create table FeeReceipt(`Receipt_Id` int UNSIGNED not null,`STD_Id` varchar(10) not null,`PaidAmount` int UNSIGNED not null,`Date` date not null, `Staff_Id` varchar(10) not null, foreign key(`STD_Id`) references student(`STD_Id`), foreign key(`Staff_Id`) references staff(`Staff_Id`),PRIMARY KEY (`Receipt_Id`));";
