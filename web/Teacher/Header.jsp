<div class="Header">
    ...
    <div class="HeaderContent Links">
        <a href="http://localhost:8080/OIM/Admin/Dashboard.jsp">Admin Dashboard | </a><a href="http://localhost:8080/OIM/Logout.jsp"><% out.print(session.getAttribute("name")+" "); %>Logout</a>
    </div>
</div>