$(document).ready(function(){
    $("#StdId").val(Students[0]);
    $("#sname").val(Students[1]);
    $("#fname").val(Students[2]);
    $("#dob").val(Students[3]);
    $("#mob").val(Students[5]);
    $("#email").val(Students[6]);
    $("#Add_date").val(Students[7]);
    $("#Add").val(Students[8]);
    $("#Dist").val(Students[9]);
    $("#State").val(Students[10]);
    $("#pincode").val(Students[11]);
    $("#country").val(Students[12]);
