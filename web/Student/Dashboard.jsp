...
<html>
    <head>
        <title>OIM | Student | DashBoard</title>
        <meta charset="UTF-8">
        ...
        <div class="Outer">
            <div class="Header">
                ...
                <div class="HeaderContent Links">
                    <a>Student | </a><a href="http://localhost:8080/OIM/Logout.jsp"><% out.print(session.getAttribute("name")+" "); %>Logout</a>
                </div>
            </div>
            <div class="Container">
                <div id="Content">
                    ...
                    <div href="" class="module_Items">
                        ...
                        <div class="Student_module">
                            <a href="ViewStudentDetail.jsp">View Profile</a> 
                        </div>
                    </div>
                    <div href="" class="module_Items">
                        <p>Course  </p>
